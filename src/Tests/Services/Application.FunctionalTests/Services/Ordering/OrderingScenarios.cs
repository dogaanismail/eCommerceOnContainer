...
public class OrderingScenarios : OrderingScenariosBase
{
    ...
    string BuildBasket()
    {
        ...
        order.Items = new List<Microsoft.eCommerceOnContainers.Services.Basket.API.Model.BasketItem>()
        {
            new Microsoft.eCommerceOnContainers.Services.Basket.API.Model.BasketItem()
            {
                Id = "1",
