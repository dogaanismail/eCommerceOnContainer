namespace Microsoft.eCommerceOnContainers.Services.Ordering.API.Infrastructure;

using Microsoft.eCommerceOnContainers.Services.Ordering.Domain.AggregatesModel.BuyerAggregate;
