using Microsoft.eCommerceOnContainers.Services.Ordering.Domain.SeedWork;

namespace Microsoft.eCommerceOnContainers.Services.Ordering.Domain.AggregatesModel.BuyerAggregate;
