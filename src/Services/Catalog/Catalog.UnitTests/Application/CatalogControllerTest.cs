using Microsoft.eCommerceOnContainers.Services.Catalog.API.IntegrationEvents;
using Microsoft.AspNetCore.Mvc;
using Microsoft.EntityFrameworkCore;
using Microsoft.eCommerceOnContainers.Services.Catalog.API;
using Microsoft.eCommerceOnContainers.Services.Catalog.API.Controllers;
using Microsoft.eCommerceOnContainers.Services.Catalog.API.Infrastructure;
using Microsoft.eCommerceOnContainers.Services.Catalog.API.Model;
using Microsoft.eCommerceOnContainers.Services.Catalog.API.ViewModel;
